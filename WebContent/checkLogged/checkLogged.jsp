	...
	<div class="middle">
		<div class="list">
			<ul class="list-ul">
				...
				<a href="checkLoggedAction.jsp?id=1" target="tabframe" style="text-decoration:none;">待审核</a></li>
				<li class="list-li" id="li2" onclick="tab(2)" >
				<a href="checkLoggedAction.jsp?id=2" target="tabframe" style="text-decoration:none;">已审核</a></li>
				<li class="search list-li" id="li4" onclick="tab(3)">
					<select id="searchType" style="border:none;outline:none;background:none;float:left;margin-top:3px;">
						<option value="3" style="border:none;outline:none;background:none;">待审核</option>
						<option value="4" style="border:none;outline:none;background:none;">已审核</option>
					</select>
		...
		<div>
			<iframe src="checkLoggedAction.jsp?id=1" name="tabframe" frameborder=0 scrolling=no HEIGHT=auto WIDTH=100% id="iframe"></iframe>
		</div>
	</div><!--zhongbukuang¨-->
...
<script type="text/javascript">
	...
	function searchLogged(){
		$("#iframe").attr('src',"checkLoggedAction.jsp?id="+$("#searchType").val()+"&key="+$("#searchKey").val());
	}
</script>
</body>
</html>